    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('marketing.vouchers.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 uppercase @error('code') border-red-500 @enderror" placeholder="Contoh: NEWYEAR2026" required maxlength="50">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('description') border-red-500 @enderror" placeholder="Deskripsi voucher">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="discount_value" id="discount_value" value="{{ old('discount_value') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('discount_value') border-red-500 @enderror" placeholder="Masukkan nilai diskon" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="max_discount" id="max_discount" value="{{ old('max_discount') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('max_discount') border-red-500 @enderror" placeholder="Kosongkan jika tidak ada batas">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="min_transaction" id="min_transaction" value="{{ old('min_transaction') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('min_transaction') border-red-500 @enderror" placeholder="Contoh: 100000">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('usage_limit') border-red-500 @enderror" placeholder="Contoh: 100">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="valid_from" id="valid_from" value="{{ old('valid_from') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('valid_from') border-red-500 @enderror">
                            @error('valid_from')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="valid_until" id="valid_until" value="{{ old('valid_until') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 @error('valid_until') border-red-500 @enderror">
                            @error('valid_until')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
